        ...
        <div id="wd-lists">
          ...
          <ol id="wd-your-favorite-recipe">
            <li>
              ...
              leave it as is for a softer sandwich.
            </li>
            <li>
            ...
            <li>
              Layer the ingredients: place lettuce leaves, chicken slices, cheese
              slices, tomato slices, and cucumber slices on the mayonnaise-covered
              bread.
            </li>
            <li>
              Sprinkle a little salt and pepper over the tomato and cucumber
              slices.
            </li>
            <li>
              Place the second slice of bread on top, mustard side down, to
              complete the sandwich. Cut in half if desired and serve immediately.
            </li>
          </ol>
